...
namespace EMVCardReader.Database
{
    public static class ATRList
    {
        public static List<List<string>> List = new List<List<string>>()
        {
            ...
            new List<string> () { "3B DF 96 00 81 31 FE 45 41 43 4F 53 2D 49 44 30 30 32 38 2E 30 31 36 6F", $"Sri Lankan driving license (eID)" },
            ...
            new List<string> () { "3B E5 00 00 81 21 45 9C 10 01 00 80 0D", $"Bank of America VISA Debit" },
